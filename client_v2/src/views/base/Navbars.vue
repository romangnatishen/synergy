  ...
  <div>
          ...
          <CCollapse :show="show" navbar>
            ...
            <CNavbarNav class="ml-auto">
              <CForm inline class="align-middle">
                <CInput class="mr-2 my-0" placeholder="Search" size="sm" />
                <CButton color="light" size="sm"> Search </CButton>
              </CForm>

              <CDropdown toggler-text="Lang" in-nav>
              ...
              <CDropdown in-nav toggler-text="User">
        ...
        <CNavbar expandable="sm" color="primary">
          ...
          <CCollapse :show="navbarDropdown" navbar>
            <CNavbarNav>
              ...
              <CDropdown toggler-text="User" in-nav>
    ...
    <CCard>
      ...
      <CCardBody>
        <CNavbar light color="light">
          <CForm inline>
            <CInput class="mr-sm-2" placeholder="Username" />
          </CForm>
        </CNavbar>
      </CCardBody>
    </CCard>
