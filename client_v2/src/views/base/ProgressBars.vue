  ...
  <div>
    <CCard>
      ...
      <CCardBody>
        ...
        <CButton @click="clicked" color="secondary" class="mt-4">
    ...
    <CCard>
      <CCardHeader>
        <CIcon name="cil-justify-center" /> <strong> Progress </strong
        ><small>labels</small>
      </CCardHeader>
      <CCardBody>
        <h6>No label</h6>
      ...
      <CCardBody>
        <div :key="index" v-for="(bar, index) in bars" class="row mb-1">
          ...
          <div class="col-sm-10 pt-1">
            <CProgress :value="bar.value" :color="bar.color" :key="bar.color" />
          </div>
        </div>
      </CCardBody>
    </CCard>
    <CCard>
      ...
      <CCardBody>
        <CProgress
          ...
          class="mb-2"
        />
        <CProgress :value="50" color="info" :striped="striped" class="mb-2" />
        <CProgress
          :value="75"
          color="warning"
          :striped="striped"
