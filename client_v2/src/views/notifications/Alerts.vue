  ...
  <CRow>
    ...
    <CCol col="12" md="6">
      <CCard>
        ...
        <CCardBody>
          <CAlert color="secondary" closeButton :show.sync="alert1">
            Dismissible Alert!
          </CAlert>
          ...
          <CButton @click="showDismissibleAlerts" color="info" class="m-1">
      ...
      <CCard>
        ...
        <CCardBody>
          <div>
            ...
            <CAlert :show.sync="dismissCountDown" closeButton color="info">
