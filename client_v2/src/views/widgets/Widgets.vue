  ...
  <div>
    ...
    <CRow>
      <CCol col="12" sm="6" lg="3">
        <CWidgetIcon header="$1.999,50" text="Income" color="gradient-primary">
          <CIcon name="cil-settings" width="24" />
        </CWidgetIcon>
      </CCol>
      <CCol col="12" sm="6" lg="3">
        <CWidgetIcon header="$1.999,50" text="Income" color="gradient-info">
          <CIcon name="cil-laptop" width="24" />
        </CWidgetIcon>
      </CCol>
      <CCol col="12" sm="6" lg="3">
        <CWidgetIcon header="$1.999,50" text="Income" color="gradient-warning">
          <CIcon name="cil-moon" width="24" />
        </CWidgetIcon>
      </CCol>
      <CCol col="12" sm="6" lg="3">
        <CWidgetIcon header="$1.999,50" text="Income" color="gradient-danger">
